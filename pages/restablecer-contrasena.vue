    ...
    <v-stepper v-model="e1" class="desktop-stepper">
        ...
        <v-dialog v-model="showModal" max-width="500px">
            <v-card>
                ...
                <v-card-text>
                    Hemos enviado un código para que recuperes tu contraseña al correo <b>{{ maskedEmail }}</b> y
                    teléfono <b>{{
        maskedPhone }}</b>
                    <p class="mt-2" style="color:#ff557c !important;">Si no tienes acceso a este correo o teléfono por
                        favor
                        envia un correo a
