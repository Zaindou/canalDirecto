        ...
        'mainStore.clientData': {
            ...
            handler(newValue) {
                if (newValue) {
                    ...
                    this.financialData[1].value = newValue ? this.formatCurrency(newValue.antiguedad_maxima) : 0;
                    this.financialData[2].value = newValue ? this.formatCurrency(newValue.ingresos_sin_prestaciones) : 0;
                    this.financialData[3].value = newValue ? this.formatCurrency(newValue.pagos_promedio_mes) : 0;
                    this.financialData[4].value = newValue ? this.formatCurrency(newValue.recomendacion_gastos_basicos) : 0;
                    this.financialData[5].value = newValue ? this.formatCurrency(newValue.recomendacion_pago_deudas) : 0;
                    this.financialData[6].value = newValue ? this.formatCurrency(newValue.disponible_saldar_deudas) : 0;
                }
            },
        },
    },
